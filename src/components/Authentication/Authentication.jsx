...
const Authentication = () => {
  ...
  const AuthRequest = async () => {
    try {
      if (isLogin) {
        url =
          "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAX8qM-jX3aBtw6RklLgkhDt1662bXXBlY";
      } else {
        url =
          "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAX8qM-jX3aBtw6RklLgkhDt1662bXXBlY";
      }
